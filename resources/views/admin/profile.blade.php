            ...
            <div class="col-md-4 col-lg-4 col-xl-4">
                <div class="card-box text-center">
                    ...
                    <div class="text-left mt-3">
                        ...
                        <p class="text-muted mb-2 font-13"><strong>Profil :</strong><span class="ml-2">{{$profile->type}}</span></p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$profile->name}}" id="firstname" placeholder="Entrez le(s) prénom(s)">
                                        </div>
                                    </div>
                                    <!-- end col -->
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" value="{{$profile->email}}" id="useremail" placeholder="Entrez l'adresse email">
                                        </div>
                                    </div>
                                    <!-- end col -->
                                </div>
