    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            <ul class="list-unstyled topnav-menu float-right mb-0">
                ...
                <li class="dropdown notification-list">
                    <a href="/admin/profil" class="nav-link nav-user mr-0 waves-effect waves-light">
            ...
            <div class="slimscroll-menu">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="/admin/rayon" :active="request()->routeIs('rayon.index')">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="/admin/utilisateur" :is-active="request()->routeIs('utilisateur.index')">
                                        <i class="fe-users"></i>
